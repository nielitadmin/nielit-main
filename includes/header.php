    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-md-end text-center d-flex align-items-center justify-content-md-end justify-content-center gap-3 mt-2 mt-md-0">
                <div class="text-end">
                    <h6 class="ministry-text mb-1" style="color: #0a1628; font-weight: 600; font-size: 0.72rem;">Ministry of Electronics & IT</h6>
                    <h6 class="mb-1" style="color: #0a1628; font-weight: 500; font-size: 0.7rem;">Government of India</h6>
                </div>
