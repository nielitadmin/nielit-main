...
if (!function_exists('publicThemeStyleDefinitions')) {
    ...
    function publicThemeStyleDefinitions(): array
    {
        return [
            ...
            'white_sky' => [
                'label' => 'White & Sky',
                'description' => 'Bright white surfaces with calm sky-blue navigation and accents.',
                'tag' => 'Light',
                'primary' => '#1e3a8a',
                'secondary' => '#0284c7',
                'accent' => '#38bdf8',
            ...
            'cloud_blue' => [
                'label' => 'Cloud Blue',
                'description' => 'Soft cloud-white background with gentle blue institutional accents.',
                'tag' => 'Light',
                'primary' => '#1d4ed8',
                'secondary' => '#60a5fa',
                'accent' => '#38bdf8',
            ...
            'ice_white' => [
                'label' => 'Ice White',
                'description' => 'Crisp white portal surfaces with cool cyan-blue highlights.',
                'tag' => 'Light',
                'primary' => '#155e75',
                'secondary' => '#0891b2',
                'accent' => '#06b6d4',
            ...
            'powder_blue' => [
                'label' => 'Powder Blue',
                'description' => 'Airy powder-blue palette with a clean white reading surface.',
                'tag' => 'Light',
                'primary' => '#1e40af',
                'secondary' => '#60a5fa',
                'accent' => '#2563eb',
            ...
            'blue_glass' => [
                'label' => 'Blue Glass',
                'description' => 'Minimal white and translucent blue feel for a modern portal.',
                'tag' => 'Light',
                'primary' => '#1e3a8a',
                'secondary' => '#2563eb',
                'accent' => '#38bdf8',
            ...
            'soft_horizon' => [
                'label' => 'Soft Horizon',
                'description' => 'Light blue horizon tones with a clear white, low-contrast base.',
                'tag' => 'Light',
                'primary' => '#0c4a6e',
                'secondary' => '#0ea5e9',
                'accent' => '#f59e0b',
