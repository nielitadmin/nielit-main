    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8 d-flex align-items-center justify-content-md-start justify-content-center text-header-group">
                ...
                <div>
                    <div class="fw-bold d-none d-sm-block" style="color: var(--blue); font-size: 0.82rem; font-family: 'Sora', sans-serif;">añ¦añ+añ+aÑìañƒaÑìañ¦aÑÇañ» añçañ¦aÑçañòaÑìañƒaÑìañ¦aÑëañ¿añ+añòaÑÇ añÅañ¦añé añ+aÑéañÜañ¿añ+ añ¬aÑìañ¦aÑîañªaÑìañ»aÑïañùañ+añòaÑÇ añ+añéañ+aÑìañÑañ+añ¿, añ¡aÑüañ¦añ¿aÑçañ¦aÑìañ¦añ¦</div>
                                    ...
                                    <div class="course-info-grid">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <div>
                                                ...
                                                <span class="info-value">Gé¦<?php echo is_numeric($row["training_fees"]) ? number_format($row["training_fees"]) : htmlspecialchars($row["training_fees"]); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="course-card">
                                ...
                                <div class="course-card-body">
                                    <div class="course-info-grid">
                                        ...
                                        <div class="info-item"><i class="fas fa-rupee-sign"></i><div><span class="info-label">Fees</span><span class="info-value">Gé¦<?php echo is_numeric($row["training_fees"]) ? number_format($row["training_fees"]) : htmlspecialchars($row["training_fees"]); ?></span></div></div>
                                    </div>
                                </div>
                                <div class="course-card-footer">
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><i class="fas fa-clock me-2" style="color: var(--gold);"></i> Mon-Fri: 09:00 AM GÇô 5:30 PM</li>
                </ul>
            </div>
        </div>
    </div>
