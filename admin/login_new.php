...
if (isset($_POST['verify_otp'])) {
    ...
    if (!isset($_SESSION['login_otp']) || !isset($_SESSION['otp_generated_time'])) {
        ...
        $_SESSION['admin'] = $_SESSION['temp_admin_username'];
        unset($_SESSION['login_otp'], $_SESSION['otp_generated_time'], $_SESSION['temp_admin_username'], $_SESSION['temp_admin_email']);
        ...
        <div class="login-body">
            ...
            <?php if ($show_otp_form): ?>
                ...
                <form method="POST" action="login.php" class="mt-3 text-center">
                    <button type="submit" name="resend_otp" class="btn btn-secondary" id="resendOtpBtn">
...
<script>
// Show loading state when logging in and sending OTP
...
if (resendOtpBtn) {
    resendOtpBtn.closest('form').addEventListener('submit', function(e) {
