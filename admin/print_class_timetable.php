...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .ct-entry { display: block; font-weight: 700; }
        .ct-meta { display: block; font-size: 8.5px; font-weight: 500; color: #475569; }
        .ct-course { display: block; font-size: 8px; color: #0369a1; font-weight: 500; }
        .legend {
            margin-top: 12px;
            font-size: 11px;
            line-height: 1.45;
...
<body>
    <div class="toolbar no-print">
        ...
        <button type="button" class="btn btn-print" onclick="window.print()">🖨 Print Timetable</button>
    </div>
