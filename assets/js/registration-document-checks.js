    ...
    global.RegistrationDocumentChecks = {
        ...
        validateBeforeSubmit: function (form) {
            var rules = [
                ...
                { name: 'tenth_marksheet', enabled: function (el) { return !!el.dataset.requireMarksheet; }, flag: 'marksheetValid', message: 'Upload a verified 10th certificate or marksheet before submitting.' },
                { name: 'twelfth_certificate', enabled: function (el) { return !!el.dataset.requireMarksheet; }, flag: 'marksheetValid', message: 'Upload a verified 12th certificate or diploma before submitting.', optional: true },
                { name: 'twelfth_marksheet', enabled: function (el) { return !!el.dataset.requireMarksheet; }, flag: 'marksheetValid', message: 'Upload a verified 12th marksheet or diploma marksheet before submitting.', optional: true },
